...
\todo{Why we get three results is unknown at the moment.} Whats really interesting is that we now can go from both English and Swedish into abstract syntax, and by extension, also to Solr-syntax.