...
\autoref{fig:swedish-lexicon} shows another instance of \texttt{LexInstrucs}, the lexicon for Swedish. \marginpar{The definition of \texttt{know_V2} is taken from StructuralSwe.gf in the RGL}
