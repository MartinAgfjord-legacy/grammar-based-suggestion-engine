...
\autoref{fig:swedish-lexicon} shows another instance of \texttt{LexInstrucs}, the lexicon for Swedish. \marginpar{The definition of \texttt{know} is taken from StructuralSwe.gf in the RGL}
