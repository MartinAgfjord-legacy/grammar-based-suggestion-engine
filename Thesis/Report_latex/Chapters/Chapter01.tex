...
\newline
\newline
An alterantive approach is to support a natural language interface \marginpar{A natural language is a language that humans use to communicate with each other.}, where the user simply writes instructions in a natural language. This method do not have the kind of limits like the traditional method with graphical objects.
...
Grammars have been used since the 1950's in the field of computer science \cite{DBLP:journals/cacm/Backus78}, and they have played a main role in the development of compilers where they are used to translate source code into machine readable instructions.
...
Natural languages consists alot of ambiguities and can often differ a lot on a linguistic level. Those properties makes it very hard and exhausting to develop accurate natural language interpreters \cite{kaufmann:2007}.
\newline
\newline
...
In fact, GF's translation approach is different from previous translation approaches and allows translation between languages that are not closely related from a structural point of view \cite{enache:2013}[p. 9].
