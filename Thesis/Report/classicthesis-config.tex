...
% ****************************************************************************************************
\newcommand{\myTitle}{Translating natural language sentences into machine readable instructions\xspace}
...
\hypersetup{%
    ...
    pdfsubject={Natural Language Processing (NLP)},%
    pdfkeywords={Grammar, Grammatical Framework, GF, Natural language, Query
language, Translation, Suggestion engine, Apache, Solr, Lucene, Tomcat, Maven,
Java EE, Functional programming},%
    pdfcreator={pdfLaTeX},%
